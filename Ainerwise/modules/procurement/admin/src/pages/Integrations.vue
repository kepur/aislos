    ...
    <section class="card p-5 space-y-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input v-model="cfg.email_from" class="input" placeholder="noreply@ainerwise.com" />
        </div>
        <div>
    ...
    <section class="card p-5 space-y-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input v-model="cfg.telegram_webhook_url" class="input" placeholder="https://api.ainerwise.com/webhooks/telegram" />
        </div>
