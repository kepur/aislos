  ...
  <div class="min-h-screen bg-slate-900 flex items-center justify-center p-4">
    <div class="w-full max-w-sm">
      <div class="text-center mb-8">
        ...
        <h1 class="text-2xl font-bold text-white">AISLOS Market</h1>
...
function switchLocale(lang) {
  ...
  applyDirection(lang)
  router.push(withLocalePrefix('/login', prefixForLocale(lang)))
}
...
async function login() {
  ...
  try {
    ...
    router.push(withLocalePrefix('/dashboard', prefixForLocale(locale.value)))
  } catch (e) {
