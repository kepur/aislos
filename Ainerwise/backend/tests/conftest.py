...
_CLEANUP_STATEMENTS = [
    ...
    "DELETE FROM analytics.events WHERE source_app = 'test-suite' OR source_app LIKE 'test-app-%' OR source_app LIKE 'test-ro-%' OR portal_key LIKE 'test-portal-%'",
    "DELETE FROM analytics.clients WHERE source_app LIKE 'test-%'",
