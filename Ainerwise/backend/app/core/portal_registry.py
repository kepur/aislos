...
_PC_AISLOS = _m(
    ...
    route_allowlist=["/", "/solutions/**", "/insights/**", "/procurement/**", "/login", "/register", "/demo-login"],
...
_PC_STORE = _m(
    ...
    route_allowlist=["/store/**", "/products/**", "/login", "/register", "/demo-login"],
    required_grants=["portal.pc.store"],
    display_name="Ainerwise Store",
...
_PC_CEBU = _m(
    ...
    route_allowlist=["/cebu/**", "/buyer/**", "/commerce/**", "/login", "/demo-login"],
...
_TARGET_EXPERIENCE_PORTALS: list[dict[str, Any]] = [
    _m(
        ...
        route_allowlist=["/", "/solutions/**", "/products/**", "/store/**", "/procurement/**", "/services/**", "/insights/**", "/cebu", "/cebu/categories", "/cebu/marketplace/**", "/cebu/how-it-works", "/cebu/pricing", "/cebu/trust-safety", "/cebu/post-request", "/submit-requirement", "/supplier-application", "/recurring-solutions", "/ai-building-brain-demo", "/ai-building-brain", "/about", "/contact", "/sign/**", "/login", "/register", "/register-buyer", "/register-role", "/register-supplier", "/forgot-password", "/demo-login"],
        required_grants=[],
    ...
    _m(
        ...
        route_allowlist=["/portal", "/portal/**", "/procurement/**", "/login", "/demo-login"],
    ...
    _m(
        ...
        physical_frontend="pc",
        layout="cebu-buyer",
        home_route="/cebu/buyer/dashboard",
        theme_key="cebu-procurement",
        menu_keys=["marketplace", "requests", "offers", "orders", "messages", "wallet", "disputes"],
        route_allowlist=["/cebu/buyer/dashboard", "/cebu", "/cebu/**", "/buyer/**", "/commerce/**", "/login", "/register", "/demo-login"],
    ...
    _m(
        ...
        menu_keys=["campaigns", "briefs", "review", "assets", "schedule", "performance", "integration"],
        route_allowlist=["/marketing", "/marketing/**", "/marketing-studio/**"],
...
_ADMIN_WORKBENCHES: list[dict[str, Any]] = [
    ...
    _admin_wb("admin_marketing", home_route="/marketing", menu_keys=["campaigns", "briefs", "integration"], route_allowlist=["/marketing/**", "/marketing-studio/**"], required_grants=["admin.marketing.read"], display_name="Marketing", legacy_portal_mode="marketing"),
