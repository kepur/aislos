...
_PC_CEBU = _m(
    ...
    route_allowlist=["/market/**", "/cebu/**", "/buyer/**", "/commerce/**", "/login", "/demo-login"],
...
_TARGET_EXPERIENCE_PORTALS: list[dict[str, Any]] = [
    _m(
        ...
        route_allowlist=["/", "/solutions/**", "/products/**", "/store/**", "/procurement/**", "/services/**", "/insights/**", "/market", "/market/categories", "/market/marketplace/**", "/market/how-it-works", "/market/pricing", "/market/trust-safety", "/market/post-request", "/cebu", "/cebu/categories", "/cebu/marketplace/**", "/cebu/how-it-works", "/cebu/pricing", "/cebu/trust-safety", "/cebu/post-request", "/submit-requirement", "/supplier-application", "/recurring-solutions", "/ai-building-brain-demo", "/ai-building-brain", "/ai-building-brain/**", "/about", "/contact", "/sign/**", "/login", "/register", "/register-buyer", "/register-role", "/register-supplier", "/forgot-password", "/demo-login"],
        required_grants=[],
