<template>
  <div>
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mb-6">
      <div>
        <h1 class="text-2xl font-bold text-gray-900">AI Runs</h1>
        <p class="text-sm text-gray-500 mt-1">Stored lead analysis workflows for admin review.</p>
      </div>
