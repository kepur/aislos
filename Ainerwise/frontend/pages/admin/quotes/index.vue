  ...
  <div>
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mb-6">
      <div>
        ...
        <p class="text-sm text-gray-500 mt-1">Manage quotations for leads and projects.</p>
      </div>
    ...
    <div class="bg-white rounded-xl border overflow-hidden">
      <table class="w-full text-sm">
        ...
        <tbody>
          <tr v-for="quote in quotes" :key="quote.id" class="border-b hover:bg-gray-50">
            <td class="px-4 py-3">
              <p class="font-medium text-gray-900 font-mono text-xs">{{ quote.id.slice(0, 8) }}</p>
            </td>
            <td class="px-4 py-3">
              <NuxtLink v-if="quote.lead_id" :to="`/admin/leads/${quote.lead_id}`" class="text-primary-600 hover:underline text-xs">
