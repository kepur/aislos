<template>
  <div v-if="project">
    ...
    <div class="mt-6 bg-white rounded-xl border p-6">
      <h2 class="font-semibold text-gray-900 mb-4">Project Timeline</h2>
      ...
      <div class="lg:col-span-2 space-y-6">
          ...
          <dl class="grid grid-cols-2 gap-3 text-sm">
            ...
            <div><dt class="text-gray-500">Lead ID</dt>
              <dd class="font-medium">
                <NuxtLink v-if="project.lead_id" :to="`/admin/leads/${project.lead_id}`" class="text-primary-600 hover:underline">
        ...
        <div class="bg-white rounded-xl border p-6">
          <div class="flex items-center justify-between mb-4">
            <h2 class="font-semibold text-gray-900">Team</h2>
            <button
        ...
        <!-- Project Plan -->
        <div class="bg-white rounded-xl border p-6">
          <h2 class="font-semibold text-gray-900 mb-4">Project Plan</h2>
