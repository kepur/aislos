<template>
  <div>
    <NuxtLink to="/admin/products" class="text-sm text-primary-600 hover:underline">&larr; Back to Products</NuxtLink>
    <h1 class="text-2xl font-bold text-gray-900 mt-4 mb-6">Create Product</h1>
    ...
    <form class="max-w-3xl space-y-6" @submit.prevent="handleSubmit">
      ...
      <div class="bg-white rounded-xl border p-6 space-y-4">
        <h2 class="font-semibold text-gray-900">Pricing & Logistics</h2>
      ...
      <div class="flex gap-3">
        ...
        <NuxtLink to="/admin/products" class="px-4 py-2 text-sm border border-gray-300 rounded-lg hover:bg-gray-50">Cancel</NuxtLink>
      </div>
    </form>
  </div>
</template>
