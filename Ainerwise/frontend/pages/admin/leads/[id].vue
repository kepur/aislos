<template>
  <div v-if="lead">
    <NuxtLink to="/admin/leads" class="text-sm text-primary-600 hover:underline">&larr; Back to Leads</NuxtLink>
    ...
    <div class="mt-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div class="lg:col-span-2 space-y-6">
        ...
        <div class="bg-white rounded-xl border p-6">
          <div class="flex items-center justify-between mb-4">
            <h2 class="font-semibold text-gray-900">Site Surveys</h2>
            <button
        ...
        <div class="bg-white rounded-xl border p-6">
          <div class="flex items-start justify-between gap-4 mb-4">
            <div>
              <h2 class="font-semibold text-gray-900">AI Analysis</h2>
      ...
      <div class="space-y-6">
        ...
        <div class="bg-white rounded-xl border p-6">
          <h2 class="font-semibold text-gray-900 mb-4">Lead Conversion</h2>
          <div class="grid grid-cols-3 gap-3 text-sm">
            ...
            <div class="rounded-lg bg-gray-50 p-3">
              ...
              <p class="font-semibold text-gray-900 mt-1 capitalize">{{ leadStageValue }}</p>
            </div>
        ...
        <div class="bg-white rounded-xl border p-6">
          <h2 class="font-semibold text-gray-900 mb-4">Operations</h2>
          <div class="space-y-3">
            <button
          ...
          <div v-if="projectCreated" class="mt-3 p-2 rounded-lg bg-indigo-50 text-indigo-700 text-xs">
            Project created.
            <NuxtLink :to="`/admin/projects/${projectCreated}`" class="font-medium underline">View Project &rarr;</NuxtLink>
          </div>
          <div v-if="quoteCreated" class="mt-3 p-2 rounded-lg bg-emerald-50 text-emerald-700 text-xs">
            Draft quote generated.
            <NuxtLink :to="`/admin/quotes`" class="font-medium underline">View Quotes &rarr;</NuxtLink>
          </div>
        ...
        <!-- Assignment -->
        <div class="bg-white rounded-xl border p-6">
          <h2 class="font-semibold text-gray-900 mb-4">Assignment</h2>
        ...
        <!-- Notes -->
        <div class="bg-white rounded-xl border p-6">
          <h2 class="font-semibold text-gray-900 mb-4">Admin Notes</h2>
          <textarea
            v-model="notes"
            rows="5"
