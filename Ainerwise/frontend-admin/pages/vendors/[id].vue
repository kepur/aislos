<template>
  <div v-if="vendor">
    <NuxtLink to="vendors" class="text-sm text-primary-600 hover:underline">&larr; Back to Vendors</NuxtLink>

    <div class="mt-4 flex items-center justify-between">
      <h1 class="admin-page-title">{{ vendor.name }}</h1>
    ...
    <div class="mt-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
      <div class="lg:col-span-2 space-y-6">
        ...
        <div class="admin-card">
          <h2 class="admin-section-title mb-4">Company Information</h2>
