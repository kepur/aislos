    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div class="lg:col-span-2 admin-card">
        <div class="flex items-center justify-between mb-4">
          ...
          <NuxtLink to="leads" class="text-xs text-cyan-400 hover:text-cyan-300 transition">View All →</NuxtLink>
        </div>
      ...
      <div class="admin-card">
        <div class="flex items-center justify-between mb-4">
          ...
          <NuxtLink to="vendors" class="text-xs text-cyan-400 hover:text-cyan-300 transition">View All →</NuxtLink>
        </div>
